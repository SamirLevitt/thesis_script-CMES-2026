...
# calculating avg. %s innovativeness per century
...
data = [
    ...
    ["Phono Innovativeness","wp_proto features", "mp_west % per cen.", "mp_cs % per cen.", "mp_arab % per cen.", f"{(tryround(mp_old))}% per cen."],
    ["Morph Innovativeness","wm_proto features", "mm_west % per cen.", "mm_cs % per cen.", "mm_arab % per cen.", f"{(tryround(mm_old))}% per cen."],
    ["Syntx Innovativeness","ws_proto features", "ms_west % per cen.", "ms_cs % per cen.", "ms_arab % per cen.", f"{(tryround(ms_old))}% per cen."],
    ["Total Innovativeness","total_proto features", "mx_west", "mx_cs % per cen.", "mx_arab % per cen.", f"{(tryround(mx_old))}% per cen."]
]
